...
git clone --branch v0.6.0 --depth 1 https://v4.gh-proxy.org/https://github.com/google/glog
cd glog
mkdir build_0_6_0 
cd build_0_6_0
...
git clone --branch v3.1-stable --depth 1 https://v4.gh-proxy.org/https://github.com/warmcat/libwebsockets
cd libwebsockets
...
git clone --branch v3.9.0 --depth 1 https://v4.gh-proxy.org/https://github.com/protocolbuffers/protobuf
cd protobuf
...
git clone -b rel-4.2.1 https://v4.gh-proxy.org/https://github.com/analogdevicesinc/libaditof.git
